      ...
      AppPanel(child: Obx(() =>
          Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(children: [
                  const Icon(
                      Icons.calendar_month_outlined, color: AppColors.gold,
                      size: 19),
                  const SizedBox(width: 9),
                  const Expanded(child: Text('STEP 1: SELECT STAY DATES',
                      style: TextStyle(color: AppColors.gold,
                          fontSize: 15,
                          fontWeight: FontWeight.w800))),
                  if(controller.nights > 0)GoldPill(
                      text: '${controller.nights} Nights')
                ]),
                const SizedBox(height: 20),
                Row(children: [
                  Expanded(child: _DateField(label: 'Check-in Date',
                      value: DateUtils.formatDate(controller.checkIn.value),
                      onTap: () => "")),
                  SizedBox(width: 14),
                  Expanded(child: _DateField(label: 'Check-out Date',
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children: [
                    ...
                    Text(value.isEmpty ? 'Select date' : value,
                        style: TextStyle(color: value.isEmpty
